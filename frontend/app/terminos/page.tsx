export default function Terminos() {
    return (
        <>
            <section className="max-w-4xl my-6 mx-auto px-4 py-8 text-gray-800 dark:text-gray-200 bg-white dark:bg-gray-900">
                <h1 className="text-3xl font-bold mb-6 text-blue-600 dark:text-blue-400">Términos y Condiciones de Servicio</h1>
                ...
                <div className="space-y-6">
                    ...
                    <div className="p-4 bg-yellow-50 border-l-4 border-yellow-500 dark:bg-gray-800 dark:border-yellow-600 rounded">
                        <h2 className="text-xl font-bold text-yellow-800 dark:text-yellow-400 mb-2">2. EXENCIÓN DE RESPONSABILIDAD FINANCIERA (AVISO IMPORTANTE)</h2>
                        <p className="font-medium">Esta Plataforma es una herramienta exclusivamente DIDÁCTICA y EDUCATIVA. Todas las simulaciones, datos de mercado, gráficos, operaciones y saldos mostrados son virtuales y se realizan con DINERO FICTICIO.</p>
                        <p className="mt-2">Ninguno de los contenidos, herramientas o resultados generados en este sitio constituyen una oferta, recomendación, asesoramiento o invitación a invertir en mercados financieros reales. El rendimiento pasado de las simulaciones no garantiza resultados futuros en inversiones reales. Los creadores de la Plataforma no se hacen responsables de pérdidas económicas derivadas de decisiones que el usuario tome en el mercado financiero real basándose en el uso de este simulador.</p>
                    </div>
